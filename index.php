...
<head>
  ...
  <title>Payondego | Landing page</title>
  <meta content="" name="description">
  <meta content="" name="keywords">

  <!-- Favicons -->
  <link href="assets/favicons/faviconlght.png" rel="icon">
  <link href="assets/favicons/faviconlght.png" rel="apple-touch-icon">
...
<body>
  ...
  <header id="header" class="fixed-top d-flex align-items-center">
    <div class="container d-flex justify-content-between align-items-center">
      ...
      <div class="logo">
        <h1><a href="?_payondego=landingpage">Payondego</a></h1>
        ...
        <div class="col-12 hero-text-image">
          <div class="row">
            <div class="col-lg-8 text-center text-lg-start">
              <h1 data-aos="fade-right">Payondego App</h1>
            ...
            <div class="col-lg-4 iphone-wrap">
              ...
              <img src="assets/img/screen2.jpg" alt="Image" class="phone-2" data-aos="fade-right" data-aos-delay="200">
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        ...
        <div class="row justify-content-center text-center mb-5">
          <div class="col-md-5" data-aos="fade-up">
            <h2 class="section-heading">Gagnez du temps en utilisant Payondego</h2>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-md-4" data-aos="fade-up" data-aos-delay="">
            <div class="feature-1 text-center">
              ...
              <h3 class="mb-3">Contactez le service client 24H / 24</h3>
              <p>Nous proposons un service de clientel accessible 24H/24 qui peut être joint par téléphone ou par courier éléctroque</p>
            </div>
          </div>
          <div class="col-md-4" data-aos="fade-up" data-aos-delay="100">
            <div class="feature-1 text-center">
              ...
              <h3 class="mb-3">Retrouvez trois façons de payer</h3>
              <p>Payez les services par une multitude de méthodes de paiement | Decouvrez ces mêthodes de paiement en téléchargeant l'qpplication</p>
            </div>
          </div>
          <div class="col-md-4" data-aos="fade-up" data-aos-delay="200">
            <div class="feature-1 text-center">
              ...
              <h3 class="mb-3">Partager Payondego</h3>
              <p>Gagner une retrocommission en partageant payondego au prêt des vos amis et connaissances </p>
            </div>
          </div>
        </div>
      ...
      <div class="container">
        <div class="row justify-content-center text-center mb-5" data-aos="fade">
          <div class="col-md-4 mb-5">
            <img src="assets/img/screen4.jpg" alt="Image" class="img-fluid w-75">
          </div>
          <div class="col-md-4 mb-5">
            <img src="assets/img/screen3.jpg" alt="Image" class="img-fluid w-75">
          </div>
          <div class="col-md-4 mb-5">
            <img src="assets/img/screen5.jpg" alt="Image" class="img-fluid w-75">
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-md-4">
            <div class="step">
              ...
              <h3>Connexion | Enregistrement</h3>
              <p>Créez un compte ou connectez vous et commencer votre session</p>
            </div>
          </div>
          <div class="col-md-4">
            <div class="step">
              ...
              <p>Choisissez une méthode de paiement selon votre operateur téléphonique</p>
            </div>
          </div>
          <div class="col-md-4">
            <div class="step">
              <span class="number">03</span>
              <h3>Profitez de l'application payondego</h3>
              <p>Puis bénéfissiez de toutes les fonctionnalités que peut fournir payondego</p>
            </div>
          </div>
        </div>
      </div>
